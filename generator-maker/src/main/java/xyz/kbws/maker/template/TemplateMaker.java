...
import xyz.kbws.maker.meta.enums.FileGenerateTypeEnum;
import xyz.kbws.maker.meta.enums.FileTypeEnum;
import xyz.kbws.maker.template.enums.FileFilterRangeEnum;
import xyz.kbws.maker.template.enums.FileFilterRuleEnum;
import xyz.kbws.maker.template.model.FileFilterConfig;
...
import xyz.kbws.maker.template.FileFilter;
...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath).getParent() + File.separator + "demo-projects/Spring-Template";
        String inputFilePath1 = "src/main/java/xyz/kbws/common";
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, templateMakerModelConfig, 1855630851069722624L);
