...
import xyz.kbws.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillModelConfig(Meta meta) {
        ...
        for (Meta.ModelConfig.ModelInfo modelInfo : modelInfoList) {
            ...
            if (StrUtil.isNotEmpty(groupKey)) {
                ...
                String allArgs = modelInfo.getModels().stream()
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "空白无上");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "xyz.kbws");
